...
<!--      <a href="javascript:void(0);" v-if="blogData.blogSort.uid"-->
...
<!--            <li class="lmname">-->
<!--              <span class="iconfont">&#xe603;</span>-->
<!--              <a href="javascript:void(0);" @click="goToSortList(blogData.blogSort.uid)">-->
<!--                {{ blogData.blogSort ? blogData.blogSort.sortName : "" }}-->
<!--              </a>-->
<!--            </li>-->
<!--            <li class="createTime">-->
<!--              <span class="iconfont">&#xe606;</span>-->
